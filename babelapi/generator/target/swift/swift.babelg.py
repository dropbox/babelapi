...
#            self._generate_route_class(namespace, route)
    ...
    def _class_declaration_for_data_type(self, data_type):
        ...
        name = self._class_name_for_data_type(data_type)
        return 'public class {}{}'.format(name, extends)
    ...
    def _generate_union_type(self, namespace, data_type):
        with self.block('public enum {}'.format(self._class_name_for_data_type(data_type))):
            for field in data_type.fields:
